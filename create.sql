...
CREATE TABLE IF NOT EXISTS `agent_locales` (
  ...
  `extras` JSON DEFAULT NULL COMMENT 'Locale-specific additional fields (JSON)',
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `extras` JSON DEFAULT NULL COMMENT 'Additional metadata payload (emotion, speech, etc)',
